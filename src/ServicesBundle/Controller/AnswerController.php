...
use ServicesBundle\Entity\Answer;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $answers = $em->getRepository('ServicesBundle:Answer')->findAll();
    ...
    {
        $answer = new Answer();
        $form = $this->createForm('ServicesBundle\Form\AnswerType', $answer);
    ...
    {
        $deleteForm = $this->createDeleteForm($answer);
        $editForm = $this->createForm('ServicesBundle\Form\AnswerType', $answer);
